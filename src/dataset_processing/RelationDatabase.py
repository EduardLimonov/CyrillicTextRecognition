...
#HDF_FILE = 'D:\\projects\\datasets\\letters\\LetterColorImages3.h5'
...
class RelationDatabase:
    ...
    def __create_relation_set(self) -> None:
        ...
        with open(RESOURCES_PATH + 'variance.txt', 'w') as f:
            f.writelines(['%s\t%s' % (k, str(variance[k])) for k in variance])
